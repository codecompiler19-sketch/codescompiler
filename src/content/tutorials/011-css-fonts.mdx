...
<body>
    ...
    p class="small"This text has a 'small' font size.

    p class="medium"This text has a 'medium' font size.

    p class="larger"This text has a 'larger' font size.

    p class="px"This text has a font size of 18px.

    p class="percent"This text has a font size of 25%.
...
<body>
    ...
    p class="normal"This text has a 'normal' font-weight.

    p class="bold"This text has a 'bold' font-weight.

    p class="lighter"This text has a 'lighter' font-weight.

    p class="number"This text has a font-weight of 600.
...
<body>
    ...
    p class="normal"It has 'normal' font-style.

    p class="italic"It has 'italic' font-style.

    p class="oblique"It has 'oblique' font-style.
