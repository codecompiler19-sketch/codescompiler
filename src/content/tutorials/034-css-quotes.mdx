...
<body>
   pTutorialspoint CSS Quotes set to &lti&gtnone&lt/i&gt
</body>
</html>
```
...
<body>
   ### Using quotes symbol:
   p<q id="quote1">Tutorialspoint CSS Quotes.</q>
   p<q id="quote2">Tutorialspoint CSS Quotes</q>.</q>
   p<q id="quote1">Tutorialspoint CSS <q id="quote2">Quotes</q>.</q>
   pTutorialspoint CSS <q id="quote3">Quotes</q>.
   p<q id="quote4">Tutorialspoint CSS Quotes</q>.</q>
   p<q id="quote5">Tutorialspoint CSS<q id="quote5">Quotes</q>.</q>

   ### Using entity number:
   p<q id="quote6">Tutorialspoint CSS Quotes.</q>
   p<q id="quote6">Tutorialspoint CSS<q id="quote6">Quotes</q>.</q>
   p<q id="quote7">Tutorialspoint CSS Quotes.</q>
   pTutorialspoint CSS <q id="quote8">Quotes</q>.
   p<q id="quote9">Tutorialspoint CSS <q id="quote9">Quotes</q>.</q>
   p<q id="quot10">Tutorialspoint CSS Quotes.</q>
</body>
</html>
```
...
<body>
   p<q>Tutorialspoint CSS Quotes.</q>
</body>
</html>
```
...
<body>
   p<q lang="en">Tutorialspoint CSS <q lang="en">Quotes</q>.</q>
   pTutorialspoint CSS <q lang="fr">Quotes</q>.
</body>
</html>
```
