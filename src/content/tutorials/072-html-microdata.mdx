...
<body>
   <div itemscope>
      <p>My name is</p> <span itemprop="name">Zara</span>.
   </div>
   <div itemscope>
      <p>My name is</p> <span itemprop="name">Nuha</span>.
   </div>
</body>
</html>
```
...
```html
<div itemscope>
   <img itemprop="image" src="tp-logo.gif" alt="CodesCompiler">
</div>
```
...
<body>
   <div itemscope>
      <section itemscope itemtype="http://data-vocabulary.org/Person">
         ...
         <p>
            <img itemprop="photo" src="http://www.codescompiler.com/green/images/logo.png">
