...
Table of contentThe SQL TOP ClauseTOP with ORDER BY ClauseTOP Clause with PERCENTTOP with WHERE ClauseTOP Clause With DELETE StatementTOP and WITH TIES ClauseUses of TOP Clause
