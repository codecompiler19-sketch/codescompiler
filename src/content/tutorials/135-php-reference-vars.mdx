...
echo "`### `Dynamic Theme Loader";

// 3. We use Variable Variables to extract the text from the chosen name!
echo "The system chose the setting: **\$active_selection**`<br>`";
echo "The actual color palette loaded is: **" . $$active_selection . "**";
