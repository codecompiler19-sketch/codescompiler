...
The following example illustrates the use of the action attribute. When we click the submit button, the form will redirect us to the home page of CodesCompiler:
...
<body>
   ...
   <form action = "https://www.codescompiler.com">
...
<body>
   ...
   <form action = "https://www.codescompiler.com" method = "post">
...
On clicking the submit button, the user will be redirected to the home page of CodesCompiler.
...
<body>
   ...
   <form action = "https://www.codescompiler.com" target = "_self">
...
<body>
   ...
   <form action = "https://www.codescompiler.com" target = "_blank" autocomplete="off" method = "get" novalidate>
...
```html
<form action = "https://www.codescompiler.com" target = "_blank" autocomplete="off" method = "get">
```
...
```html
<form action = "https://www.codescompiler.com" target = "_blank" autocomplete="off" method = "get" enctype = "text/plain">
```