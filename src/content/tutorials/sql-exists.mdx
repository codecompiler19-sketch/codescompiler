---
title: "SQL – EXISTS"
description: "Check if a subquery returns any rows at all using the EXISTS operator for efficient conditional filtering."
category: "sql"
order: 38
---
...
INSERT INTO enrollments VALUES
  ...
  querySql={`-- Find students who have at least one completed enrollment
