---
title: "PHP - Scalar Type Declarations"
description: "Learn PHP - Scalar Type Declarations with clear explanation, code examples, and practical PHP development guide."
category: "php"
order: 280
group: "PHP Basics"
seoTitle: "PHP - Scalar Type Declarations — CodesCompiler PHP Guide"
permalink: "php-scalar-type-declarations"
---
...
Run this code and see how it shows anerror.
...
To counter the weak type checking of PHP, a strict mode has been introduced. This mode is enabled with adeclare statement−
...
Uncomment thedeclarestatement at the top of this code and run it. Now it will produce anerror−
