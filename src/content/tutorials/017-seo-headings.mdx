...
<body>
   ...
   <header>
      ...
      ### TutorialsPoint Guide to Webpage Headings
   </header>
   </article>
</body>
```
...
p style`=`"text-align:center"Pic 3: Header Tag H1 in a `<a target="_blank" href`=`"https://www.tutorialspoint.com/index.htm">`www.tutorialspoint.com`</a>` webpage
