---
title: "CSS - min-block-size Property"
description: "Learn CSS - min-block-size Property with clear CSS layout principles, modern selectors, and practical examples."
category: "css"
order: 780
group: "CSS Basics"
seoTitle: "CSS - min-block-size Property — CodesCompiler CSS Guide"
...
| length | It sets the min-block-size of the element using length units (e.g. px, em, rem etc.) |
| percentage | It sets the min-block-size of the element using percentage value relative to the size of the containing element. |
