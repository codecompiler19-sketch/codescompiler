...
description: "Summarize data across multiple rows using SQL aggregate functions like COUNT, SUM, AVG, MIN, and MAX."
category: "sql"
order: 17
---
...
INSERT INTO enrollments VALUES
  ...
  querySql={`-- Academy-wide statistics in one query
