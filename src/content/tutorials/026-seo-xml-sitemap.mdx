...
The rest of the tags are configurable. Search engine spiders might or might not accommodate these additional tags. For details regarding the compatibility of each search engine, read its instruction manual. Furthermore, each URL in a Sitemap should be from the same host, such as www.codescompiler.com, guides.codescompiler.com, etc.
...
<sitemapindex xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
   <sitemap>
	   <loc>http://wwwcodescompiler.com/sitemap01.xml.gz</loc>
		<lastmod>2023-06-18T18:21:00+00:00</lastmod>
	</sitemap>
   <sitemap>
      <loc>http://www.codescompiler.com/sitemap02.xml.gz</loc>
