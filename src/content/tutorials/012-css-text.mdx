...
<body>
    ...
    <p>This paragraph demonstrates how the text-justify property works. It adjusts the spacing between words.
...
<body>
    ...
    <p>This text is displayed in a vertical layout using text-orientation.
