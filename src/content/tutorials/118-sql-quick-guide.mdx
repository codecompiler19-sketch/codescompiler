...
| `<>` | Checks if the values of two operands are equal or not | `(a <> b)` is true. |
| `>` | Checks if the value of left operand is greater than right | `(a > b)` is not true. |
| `<` | Checks if the value of left operand is less than right | `(a < b)` is true. |
...
| `!<` | Checks if the value of left operand is not less than right | `(a !< b)` is false. |
| `!>` | Checks if the value of left operand is not greater than right | `(a !> b)` is true. |
