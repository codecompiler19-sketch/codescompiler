...
<body>
   ## CSS unicode-bidi - normal Value
   pThe following text is displayed in its default order from right-to-left direction.
   <div class="box">
...
<body>
   ## CSS unicode-bidi - bidi-override Value
   pThe following text is displayed in reverse order of the characters in right-to-left direction.
   <div class="box">
      Lorem Ipsum is simply dummy text of the printing and typesetting industry.  
   </div>
</body>
...
<body>
   ## CSS unicode-bidi - isolate Value
   pThe following text is displayed in its default order from right to left.
   <div class="box">
      Lorem Ipsum is simply dummy text of the printing and typesetting industry.  
   </div>
</body>
...
<body>
   ## CSS unicode-bidi - plaintext Value
   pThe following text is displayed in its default order from left-to-right direction.
   <div class="box">
      Lorem Ipsum is simply dummy text of the printing and typesetting industry.  
   </div>
</body>
