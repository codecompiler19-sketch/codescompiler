---
title: "SQL – CASE"
description: "Write conditional logic directly inside SQL queries using the CASE expression — SQL's version of if-then-else."
category: "sql"
order: 43
---
...
INSERT INTO enrollments VALUES
  ...
  querySql={`-- Assign performance tier labels to each student
