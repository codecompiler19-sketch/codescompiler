---
title: "CSS - tab-size Property"
description: "Learn CSS - tab-size Property with clear CSS layout principles, modern selectors, and practical examples."
category: "css"
order: 720
group: "CSS Basics"
seoTitle: "CSS - tab-size Property — CodesCompiler CSS Guide"
...
<body>
   pWithout tab-size
   p	Default tab-size to 8 characters.
   p class="tab1"	tab-size with 3 characters.
   p   tab-size with 3 spaces.
</body>
</html>
```
