---
title: "SQL – IN"
description: "Filter rows matching any value from a list using the IN operator — a cleaner alternative to multiple OR conditions."
category: "sql"
order: 25
---
...
INSERT INTO enrollments VALUES
  ...
  querySql={`-- Students from top-tier cities
