...
<body>
   ...
   <script>
      function changeHTML() {
         let text = document.getElementById('text');
         text.outerHTML = <img src="https://www.codescompiler.com/static/images/logo.png?v3" alt="Logo">;
      }
   </script>
</body>
</html>
...
<body>
   ...
   <script>
      function changeHTML() {
         ...
         textNode.innerHTML = "Welcome to the CodesCompiler!";
...
<html>
<body>
   <img src = "https://www.codescompiler.com/static/images/logo.png?v3" width = "300px" id = "logoImg" alt = "logo">
   <p>
   <button onclick="changeURL()"> Change URL of Image </button>
   <script>
      function changeURL() {
         document.getElementById('logoImg').src = "https://www.codescompiler.com/static/images/simply-easy-learning.png";
      }
   </script>
</body>
</html>
