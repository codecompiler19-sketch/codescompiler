...
p style`=`"text-align:center"Pic 5: An Image Properties on `<a target="_blank" href`=`"https://www.tutorialspoint.com/index.htm">`www.tutorialspoint.com`</a>`
...
p style`=`"text-align:center"Pic 7: Source Code of an Image published on `<a target="_blank" href`=`"https://www.tutorialspoint.com/index.htm">`www.tutorialspoint.com`</a>`
