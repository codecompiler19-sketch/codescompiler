...
<body>
   ...
   <form >
      ...
      Organization: <input type = "text" name = "organization" value = "CodesCompiler" readonly/>
...
<body>
   ...
   <form >
      ...
      Organization: <input type = "text" name = "organization" value = "CodesCompiler" disabled/>
...
<body>
   ...
   <form >
      ...
      pThe * Star represents mandatory field
