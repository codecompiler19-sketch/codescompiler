...
In the below code, we extract the host from the URL. You can see that it returns 'www.codescompiler.com'.
...
```javascript
The host name of the current location is: www.codescompiler.com
```
...
<body>
   ...
   <script>
      ...
      function changePage() {
	     window.location.assign("https://www.codescompiler.com/");
      }
   </script>
</body>
</html>
