...
<body>
   ...
   <p>This line contains a line break tag,</p> <br> hence content is visible in two separate lines.

   <p>This line is</p> <hr>separated by a horizontal rule.
...
```html
<img src="logo.jpg" alt="CodesCompiler Logo" />
```
