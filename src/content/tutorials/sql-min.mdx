---
title: "SQL – MIN"
description: "Find the minimum (smallest) value in a column using the MIN() aggregate function."
category: "sql"
order: 18
---
...
INSERT INTO enrollments VALUES
  ...
  querySql={`-- What's the lowest score, cheapest course, and earliest enrollment?
