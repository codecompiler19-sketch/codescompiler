...
If the. preventDefault() was not used, it would have navigated the page to https://www.codescompiler.com.
...
<html>
<body>
	<a href="https://www.codescompiler.com" id="link">Click me to prevent default</a>
	<script>
