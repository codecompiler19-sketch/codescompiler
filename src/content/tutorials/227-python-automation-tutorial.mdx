...
class TestingStringMethods(unittest.TestCase):
   ...
   def test_string_case(self):
      # if both arguments are then it's succes
      self.assertEqual('CodesCompiler'.upper(), 'CODESCOMPILER')
   ...
   def test_is_string_upper(self):
      ...
      self.assertTrue('CODESCOMPILER'.isupper())
      self.assertFalse('CODESCompiler'.isupper())
      
   def test_string_startswith(self):
       # Used the startswith() to identify the start of the string
       self.assertTrue('codescompiler'.startswith('putor'))
       self.assertFalse('codescompiler'.startswith('point'))
