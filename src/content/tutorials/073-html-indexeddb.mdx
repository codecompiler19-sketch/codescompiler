...
description: "Learn HTML - IndexedDB with clear HTML concepts, practical examples, and maintainable markup."
category: "html"
order: 730
group: "HTML Miscellaneous"
seoTitle: "HTML - IndexedDB — CodesCompiler HTML Guide"
permalink: "html-indexeddb"
---
...
```html
const employeeData = [
   { id: "01", name: "Gopal K Varma", age: 35, email: "contact@codescompiler.com" },
   { id: "02", name: "Prasad", age: 24, email: "prasad@codescompiler.com" }
];
```
...
function add() {
   ...
   .add({ id: "01", name: "prasad", age: 24, email: "prasad@codescompiler.com" });
...
<head>
   ...
   <script type="text/javascript">
      ...
      const employeeData = [
         { id: "00-01", name: "gopal", age: 35, email: "gopal@codescompiler.com" },
         { id: "00-02", name: "prasad", age: 32, email: "prasad@codescompiler.com" }
      ];
      var db;
