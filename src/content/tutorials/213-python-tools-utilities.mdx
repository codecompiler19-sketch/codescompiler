---
title: "PYTHON - Tools/Utilities"
description: "Learn PYTHON - Tools/Utilities with clear explanation, code examples, and practical guide."
category: "python"
order: 2130
group: "Python Miscellenous"
seoTitle: "PYTHON - Tools/Utilities — CodesCompiler PYTHON Guide"
permalink: "python-tools-utilities"
---
...
Thedismodule is the Python disassembler. It converts byte codes to a format that is slightly more appropriate for human consumption.
...
Before you try to runpdb.py, set your path properly to Python lib directory. So let us try
with above example sum.py −
...
Now, try runningcProfile.pyover this filesum.pyas follow −
