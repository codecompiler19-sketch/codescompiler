...
description: "Learn JavaScript - Multimedia with clear explanation, code examples, and interactive syntax guide."
category: "javascript"
order: 2450
group: "JavaScript Miscellaneous"
seoTitle: "JavaScript - Multimedia — CodesCompiler JavaScript Guide"
permalink: "javascript-multimedia"
---
...
The JavaScriptnavigatorobject includes a child object calledplugins. This object is an array, with one entry for each plug-in installed on the browser. The navigator.plugins object is supported only by Netscape, Firefox, and Mozilla only.
