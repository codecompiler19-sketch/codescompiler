...
<body>
    ...
    <script type="text/javascript">
        function Redirect() {
            window.location = "https://www.codescompiler.com";
        }
    </script>
</body>
</html>
...
```javascript
You will be redirected to codescompiler.com main page in 10 seconds!
```
...
<body>
   <script type = "text/javascript">
      ...
      if( browsername == "Netscape" ) {
         window.location = "https://www.codescompiler.com/javascript/index.htm";
      } else if ( browsername =="Microsoft Internet Explorer") {
         window.location = "https://www.codescompiler.com/articles/category/Javascript";
      } else {
         window.location = "https://www.codescompiler.com/";
      }
   </script>      
