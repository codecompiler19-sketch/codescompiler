...
<body>
   <a href="https://www.codescompiler.com">Visit our homepage</a>
</body>

</html>
```

In this example, href is the attribute name and "https://www.codescompiler.com" is the attribute value.
...
<body>
   <p style="font-family:arial; color:#FF0000;">Welcome to CodesCompiler...
</body>
</html>
```

On executing the above example, it will display the text "Welcome to CodesCompiler..." in the "Arial" font and with a red color.
...
```html
<!-- Good Practice -->
<a href="https://www.codescompiler.com/html/html_overview.htm">
   HTML Introduction
<a>
