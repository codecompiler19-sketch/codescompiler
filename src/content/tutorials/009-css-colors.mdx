...
<body>
   ...
   ### Color Keyword - example
      ...
      pAs the keyword passed is aqua, the background will appear as aqua colored..
...
<body>
   ...
   ### Hexadecimal code - example
      ...
      pAs the hexadecimal code is #00ff00 the background will appear green.
...
<body>
   ...
   ### Short Hexadecimal code - example

      pAs the short hexadecimal code is #00f the background will appear blue.
...
<body>
   ...
   pAs the rgb(255,0,255) is set the background will appear accordingly.
...
<body>
   ...
   pAs the rgba(255,0,255,0.2) is set the background will appear with transparency value of 0.2.
...
<body>
   ...
   pAs the hsl(355,70%,50%) is set the background will appear based on the hsl values passed.
...
<body>
   ...
   pAs the hsla(355,70%,50%,0.4) is set the background will appear based on the hsla values passed, with high transparency.
...
<body>
   ...
   pAs the currentcolor keyword is used for border after color property is set as red, the border will also appear red.
