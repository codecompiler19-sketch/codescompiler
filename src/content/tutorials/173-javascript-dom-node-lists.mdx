...
<body>
    <div>
        pThis is first paragraph.
        pThis is second paragraph.
        pThis is third paragraph.
        pThis is fourth paragraph.
    </div>
    <script>
...
<body>
    pClick the button below to add style to all "div" elements.
   <div>Div 1</div>
   <div>Div 2</div>
   <div>Div 3</div>
   <div>Div 4</div>
