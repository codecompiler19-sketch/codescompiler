...
Table of contentThe SQL CREATE DATABASE StatementHow to Verify the Database Was CreatedHow to Select and Use a DatabaseRemoving a Created DatabaseSQL CREATE DATABASE with IF NOT EXISTS ClauseRules for Naming a Database
