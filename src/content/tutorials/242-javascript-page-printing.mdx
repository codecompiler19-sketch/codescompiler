...
- If you do not want to keep an extra copy of a page, then you can mark your printable text using proper comments like `<!-- PRINT STARTS HERE -->`..... `<!-- PRINT ENDS HERE -->` and then you can use PERL or any other script in the background to purge printable text and display for final printing. We at CodesCompiler use this method to provide print facility to our site visitors.
