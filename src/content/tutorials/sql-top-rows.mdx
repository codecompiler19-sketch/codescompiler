---
title: "SQL – Limiting Rows"
description: "Control how many rows are returned using LIMIT (and TOP/FETCH in other databases)."
category: "sql"
order: 16
---
...
INSERT INTO enrollments VALUES
  ...
  querySql={`-- Top 3 students by score (our leaderboard)
