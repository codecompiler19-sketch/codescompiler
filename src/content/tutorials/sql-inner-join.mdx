...
description: "Retrieve records that have matching values in both tables using INNER JOIN."
category: "sql"
order: 29
---
...
INSERT INTO enrollments VALUES
  ...
  querySql={`-- Only enrolled students (students with no enrollments are excluded)
SELECT s.name,
       c.title AS course,
       e.status,
       e.final_score
