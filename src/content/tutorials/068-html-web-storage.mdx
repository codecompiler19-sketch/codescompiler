...
<body>
   ...
   pRefresh the page to increase number of hits.
   pClose the window and open it again and check the result.
</body>	
</html>
```
...
<body>
   ...
   pRefreshing the page would not to increase hit counter.
   pClose the window and open it again and check the result.
</body>
</html>
```