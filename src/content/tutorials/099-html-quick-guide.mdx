...
description: "Learn HTML - Quick Guide with clear HTML concepts, practical examples, and maintainable markup."
category: "html"
order: 990
...
The `p` tag offers a way to structure your text into different paragraphs. Each paragraph of text should go in between an opening `p` and a closing  tag as shown below in the example −
...
<html>
   ...
   <body>
      pHere is a first paragraph of text.
      pHere is a second paragraph of text.
      pHere is a third paragraph of text.
   </body>
...
<html>
   ...
   <body>
      pThis text is not in the center.
      
      <center>
         pThis text is in the center.
      </center>
   </body>
...
<html>
   ...
   <body>
      pThis is paragraph one and should be on top
      <hr />
      pThis is paragraph two and should be at bottom
   </body>
...
So here `p`.... is an HTML element, `<h1>`...`</h1>` is another HTML element. There are some HTML elements which don't need to be closed, such as `<img.../>` , `<hr />` and `<br />` elements. These are known as void elements .
...
For example, `p` is starting tag of a paragraph and  is closing tag of the same paragraph but `p`This is paragraph is a paragraph element.
...
<html>
   ...
   <body>
      pThe following word uses an <i>italicized</i> typeface.
   </body>
...
<html>
   ...
   <body>
      pThe following word uses an <u>underlined</u> typeface.
   </body>
...
<html>
   ...
   <body>
      pThe following word uses a <strike>strikethrough</strike> typeface.
   </body>
...
<html>
   ...
   <body>
      pThe following word uses a <tt>monospaced</tt> typeface.
   </body>
...
<html>
   ...
   <body>
      pThe following word uses a <sup>superscript</sup> typeface.
   </body>
...
<html>
   ...
   <body>
      pThe following word uses a <sub>subscript</sub> typeface.
   </body>
...
<html>
   ...
   <body>
      pI want to drink <del>cola</del> <ins>wine</ins>
   </body>
...
<html>
   ...
   <body>
      pThe following word uses a <big>big</big> typeface.
   </body>
...
<html>
   ...
   <body>
      pThe following word uses a <small>small</small> typeface.
   </body>
...
<html>
   ...
   <body>
      pThis is the example of <span style = "color:green">span tag</span>
...
<html>
   ...
   <body>
      pThe following word uses an <em>emphasized</em> typeface.
   </body>
...
<html>
   ...
   <body>
      p<code>document.write("<var>user-name</var>")</code>
   </body>
...
<html>
   ...
   <body>
      pThis is <comment>not</comment> Internet Explorer.
   </body>
...
<html>
   ...
   <body>
      pSetting image width and height
...
<html>
   ...
   <body>
      pClick any of the following links
...
This way you can assign different links to different coordinates of the image and when those coordinates are clicked, you can open corresponding linked document. To learn more about ismap attribute, you can check HTML ismap Attribute
...
- rect `=` x 1 , y 1 , x 2 , y 2 x 1 and y 1 are the coordinates of the upper left corner of the rectangle; x 2 and y 2 are the coordinates of the lower right corner.

rect `=` x 1 , y 1 , x 2 , y 2

x 1 and y 1 are the coordinates of the upper left corner of the rectangle; x 2 and y 2 are the coordinates of the lower right corner.

- circle `=` x c , y c , radius x c and y c are the coordinates of the center of the circle, and radius is the circle's radius. A circle centered at 200,50 with a radius of 25 would have the attribute coords `=` "200,50,25"

circle `=` x c , y c , radius

x c and y c are the coordinates of the center of the circle, and radius is the circle's radius. A circle centered at 200,50 with a radius of 25 would have the attribute coords `=` "200,50,25"

- poly `=` x 1 , y 1 , x 2 , y 2 , x 3 , y 3 , ... x n , y n The various x-y pairs define vertices (points) of the polygon, with a "line" being drawn from one point to the next point. A diamond-shaped polygon with its top point at 20,20 and 40 pixels across at its widest points would have the attribute coords `=` "20,20,40,40,20,60,0,40" .
...
<html>
   ...
   <body bgcolor = "#b5dcb3">
      ...
      pSo now click any link and see the result.
   </body>
...
<html>
   ...
   <body>
      ...
      pDocument content also go here...
   </body>
...
<html>
   ...
   <body>
      ...
      <div style = "color:red">
         ...
         pFollowing is a list of vegetables
      ...
      <div style = "color:green">
         ...
         pFollowing is a list of fruits
...
<html>
   ...
   <body>
      pThis is <span style = "color:red">red</span> and this is
...
<html>
   ...
   <body text = "blue" bgcolor = "green">
      pUse different color names for for body and table and see the result.
...
<html>
   ...
   <body text = "#0000FF" bgcolor = "#00FF00">
      pUse different color hexa for for body and table and see the result.
...
<html>
   ...
   <body text = "rgb(0,0,255)" bgcolor = "rgb(0,255,0)">
      pUse different color code for for body and table and see the result.
...
<html>
   ...
   <body>
      ...
      pThis is the page's default font.
...
<html>
   ...
   <body>
      p<font color = "green" size = "5">Hello, World!</font>
   </body>
   ...
   <body>
      <div style = "width:100%">
         ...
         <div style = "background-color:#eee; height:200px; width:350px; float:left;" >
            pTechnical and Managerial Tutorials
         </div>
