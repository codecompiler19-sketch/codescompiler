---
title: "PHP - Variable Arguments"
description: "Learn PHP - Variable Arguments with clear explanation, code examples, and practical PHP development guide."
category: "php"
order: 630
group: "PHP Functions"
seoTitle: "PHP - Variable Arguments — CodesCompiler PHP Guide"
permalink: "php-variable-arguments"
---
...
In the following example, the user defined functionmyfunction()is capable of receiving variable number of values and finds their average.
...
You can use aforeachloop to traverse the array inside the function. The function may have any positional arguments before the variable length argument. From the received values, the positional arguments will be populated first, leaving others to be copied to the array.
