...
- host− This is the host running your SMTP server. You can specify IP address of the host or a domain name liketutorialspoint.com. This is an optional argument.
...
<html>
  <head></head>
  <body>
    pThis is an e-mail message to be sent in **HTML format**
