---
title: "HTML - ASCII Codes Reference"
description: "Learn HTML - ASCII Codes Reference with clear HTML concepts, practical examples, and maintainable markup."
category: "html"
order: 900
group: "HTML References"
seoTitle: "HTML - ASCII Codes Reference — CodesCompiler HTML Guide"
permalink: "html-ascii-codes"
---

## HTML - ASCII Codes Reference

ASCII stands for American Standard Code for Information Interchange . There are 2 7 = 128 printable characters which can be represented by different 7-BIT ASCII codes, each of which can be represented by a 7-digit binary number from 0000000 to 1111111.
