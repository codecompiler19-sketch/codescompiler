...
const booksData = [
  {
    slug: 'toddlers-first-guide-to-emotions',
    title: 'Toddler\'s First Guide to EMOTIONS',
    tagline: 'Help Your Little One Understand, Express and Manage Their Emotions',
    description: 'A beautifully illustrated book with 50 lessons to help toddlers recognize emotions, express feelings, build empathy, and grow confidence.',
    coverImage: '/images/books/toddlers-emotions.jpg',
    pages: 50,
    downloads: '100',
    ...
    whatsappUrl: 'https://whatsapp.com/channel/0029VbDJ9Lc0VycCT9PJuu0W',
    youtubeUrl: 'https://www.youtube.com/@CodeCompiler19',
    pdfUrl: '#',
    isPremium: true,
    price: '$9.99',
    amazonUrl: 'https://www.amazon.com/dp/B0HHYTPH94',
    checkoutUrl: '#',
    learnList: [
      'Recognize Emotions',
      'Express Feelings',
    ...
    infoTabs: [
      {
        id: 'overview',
        label: '📖 Overview',
        content: `<h3>About This Book</h3><p>Help your little one understand, express, and manage their emotions with this beautifully illustrated guide designed for kids ages 2-5.</p>`
      },
      {
        id: 'details',
        label: '📊 Book Details',
        content: `<table style="width:100%; border-collapse:collapse;"><tr><td style="padding:10px 12px;color:#64748b;font-weight:600;">Price</td><td style="padding:10px 12px;font-weight:700;color:#04AA6D;">$9.99</td></tr></table>`
      }
    ]
  },
  {
...
<p>To provide the highest-quality, most accessible coding education for the next generation of web builders — completely free of charge, without any sign-up barriers.</p>`
  ...
  },
  {
    ...
    coverImage: '/images/books/css-for-kids.png',
    pages: 50,
    downloads: '1,840',
    updated: 'June 2026',
    level: 'Beginner Friendly',
...
<ul>
  ...
  },
  {
    ...
    coverImage: '/images/books/javascript-for-kids.png',
    pages: 50,
    downloads: '2,110',
    updated: 'June 2026',
    level: 'Intermediate',
  ...
  },
  {
    ...
    coverImage: '/images/books/scratch-for-kids.png',
    pages: 50,
    downloads: '3,120',
    updated: 'June 2026',
...
const outDir = path.join('c:/Users/Computer/Desktop/github/New_codecompiler/codescompiler/src/data/books');
if (!fs.existsSync(outDir)) {
  fs.mkdirSync(outDir, { recursive: true });
}

booksData.forEach(book => {
  const filePath = path.join(outDir, `${book.slug}.json`);
  fs.writeFileSync(filePath, JSON.stringify(book, null, 2), 'utf8');
});

console.log('Books extracted successfully to JSON files.');
